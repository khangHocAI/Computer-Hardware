...
ROW_0: 	MOV 	DPTR,#ROW0_CODE                    ;#!Set DPTR=start of row 0
		SJMP 	FIND                            ;#!Find col. Key belongs to
ROW_1: 	MOV 	DPTR,#ROW1_CODE                    ;#!Set DPTR=start of row
		SJMP 	FIND                            ;#!Find col. Key belongs to
ROW_2: 	MOV 	DPTR,#ROW2_CODE                    ;#!Set DPTR=start of row 2
		SJMP 	FIND                            ;#!Find col. Key belongs to
ROW_3: 	MOV 	DPTR,#ROW3_CODE                    ;#!Set DPTR=start of row 3
...
ERRFUN:	ACALL 	CLS								;#!CALL subroutine to clear screen
		MOV 	DPTR,#MSG					;#!Set DPTR to look-up table's address
E1: 	CLR 	A								;#!Clear ACC
		MOVC 	A,@A+DPTR						;#!Get code from look-up table and placing it into ACC
...
ROW0_CODE: DB 		"7","8","9","/" 				;#!ROW 0
ROW1_CODE: DB 		"4","5","6","*" 				;#!ROW 1
ROW2_CODE: DB 		"1","2","3","-" 				;#!ROW 2
ROW3_CODE: DB 		0,"0","=","+" 					;#!ROW 3
;-------ERROR MASSAGE FOR ANY INVALID INPUT
MSG:	DB		"INVALID INPUT",0
		END